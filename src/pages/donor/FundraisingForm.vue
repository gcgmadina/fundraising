    ...
    <ion-page>
        ...
        <ion-content class="ion-padding">
            <form id="fundraising-form" @submit.prevent="submit($event)">
                ...
                <ion-item>
                    <ion-select name="method" required label="Metode Pembayaran" mode="md" v-model="paymentMethod">
                ...
                <ion-item>
                    <ion-input name="bill_name" required label="Pemilik Rekening" labelPlacement="floating"
                        mode="md"></ion-input>
                </ion-item>
                <ion-item>
                    <ion-input name="bill_no" required label="Nomor Rekening" labelPlacement="floating"
                        mode="md"></ion-input>
                </ion-item>
...
const submit = (e) => {
    ...
    data.bill_date = receivedDate.value;
